...
def section_1(pdf: PdfPages):
    ...
    body2 = (
        ...
        "headline static-vs-trajectory comparison figure. This demonstrates that "
        "trajectory drift extends the effective capture range by ~14x over "
        "the static criterion at MCA conditions as cells experience accumulated"
        "radial magnetic forces over the 4mm integration window.\n\n"
...
def section_2(pdf: PdfPages):
    ...
    body = (
        ...
        "~ 1.46 mm. These parameters are modular and different set ups have been used "
