...
Parameters
----------
- Cell radius: 10 um, SPION: 200 pg, χ = 2.0
...
_COLOR_CAPTURED = COLORS_CODE_DEFAULT      # blue
_COLOR_ESCAPED  = COLORS_THRESHOLD_HIGH    # red
...
def make_figure():
    ...
    # -----------------------------------------------------------------------
    # Figure layout — 1 row x 3 columns of 3D axes
    # -----------------------------------------------------------------------
