...
_COLOR_PRIMARY   = COLORS_CODE_DEFAULT      # blue
_COLOR_SECONDARY = COLORS_THRESHOLD_HIGH    # red
_COLOR_INJECT    = COLORS_THRESHOLD         # green
_COLOR_CAPTURE   = COLORS_MARKER_SOURCE     # red source marker
